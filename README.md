...
# Note: This process may take up to 2 days due to the size of the files.

# Configuration Adjustments

## Modify Configuration Files:
# Navigate to the configuration file:
cd ST-P3/stp3/configs/nuscenes/
nano Perception.yml
...
# Due to the superior processing power of the RTX 4090 compared to the RTX 3090, the first PC is used for planning.
